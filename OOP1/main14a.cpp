...
class Student {
 public:
  ...
  void Name(string name) {
      name_ = name;
      Validate();    // bräuchte man eigentlich net
  }
 ...
 private:
 string name_;   // man könnte es auch als public, da name nie invalid sein kann quasi
 int grade_;
 float gpa_;
 void Validate() {
...
int main() {
    ...
    try {
        david.Grade(10);
        //Student invalid("Invalid Imma", -1, 8.7);   // oder so
